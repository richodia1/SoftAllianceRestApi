...
builder.Services.AddSwaggerGen(setupAction =>
{
    ...
    setupAction.AddSecurityDefinition("MovieInfoApiBearerAuth", new OpenApiSecurityScheme()
    {
...
builder.Services.AddDbContext<MovieInfoContext>(
...
builder.Services.AddAuthorization(options =>
{
    options.AddPolicy("MustBeFromAntwerp", policy =>
    {
        ...
        policy.RequireClaim("movie", "Antwerp");
    });
});
